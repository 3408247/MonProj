...
#### Mes tests
Priya_1a = SoccerTeam("Priya_1a",[Player("f1",Joueur_1vs1_Strat)])
Priya_1b =SoccerTeam("Priya_1b",[Player("GARDIEN",Gard_shoot_but)])

Priya_2a = SoccerTeam("Priya_2a",[Player("j1",Joueur_2vs2_Strat),Player("j2",Joueur_2vs2_Strat)])
Priya_2b =SoccerTeam("Priya_2b",[Player("1ATTb",FonceurStrat),Player("GARDIENb",Gard_shoot_alea)])
Priya_2bb = SoccerTeam("Priya_2a",[Player("j1",Joueur_2vs2_Strat),Player("j2",Gard_shoot_but)])
...
### Pour le tournoi
team1 = SoccerTeam("team1",[Player("f1",Joueur_1vs1_Strat)])
team2 = SoccerTeam("team2",[Player("ATT1",Joueur_2vs2_Strat_bis),Player("GARD",Gard_shoot_but)])
